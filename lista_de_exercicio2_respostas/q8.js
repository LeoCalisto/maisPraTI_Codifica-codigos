...
let faturamento,pontos;

let horasDeAtividade = parseInt(prompt("Digite quantos horas de exercio realizou no mês: "));
...
console.log(`Você conseguiu ${pontos} pontos esse mês e consequentemente R$ ${faturamento} de faturamento`);