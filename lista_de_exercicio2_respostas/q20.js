...
for (let i = 0; i < 5; i++) {
    funcionarios[i] = criarFuncionario(124587,"joao",3500,3500/100*12,3500-(3500/100*12));
}
...
function criarFuncionario(matricula,nome,salarioBruto,descontoInss,salarioLiquido){
    return{
        matricula,
        nome,
        salarioBruto,
